  ...
  return (
    <div style={{ position: 'relative', width: '1024px', margin: 'auto' }}>
      ...
      <img
        ...
        style={{
          position: 'absolute',
          top: '250px', // Ajustamos la posición para más espacio
          left: '150px',
          width: '100px', // Aumentamos el tamaño del icono
      ...
      <img
        ...
        style={{
          position: 'absolute',
          top: '200px', // Ajustamos la posición para más espacio
          right: '150px',
          width: '110px', // Aumentamos el tamaño del icono
      ...
      <img
        ...
        style={{
          position: 'absolute',
          bottom: '100px', // Ajustamos la posición para más espacio
          left: '400px',
          width: '110px', // Aumentamos el tamaño del icono
