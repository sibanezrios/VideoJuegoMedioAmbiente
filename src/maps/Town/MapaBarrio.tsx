...
function MapaBarrio({ increaseGlobalScore, setFutureResults }: MapaBarrioProps) {
  ...
  const preguntasYOpciones = {
    ...
    lote: {
      pregunta: "¿Quieres convertir este espacio en un parque, a peticion de 10 niños de la comunidad?",
      opciones: [
        { texto: "Convertir el lote en parque, cumpliendo la peticion de unicamente el 10% de las personas en el pueblo", valor: "parque" },
        { texto: "Convertir el lote en zona comercial(los gastos seran donados por una empresa extranjera que quiere expandir su territorio.)", valor: "comercial" }
      ]
    }
  };
